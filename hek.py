...
def main():
    ...
    bersih()
    time.sleep(1)
    print ('\33[1;33m                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Hello \33[31;1mBangsat \33[0;36m:)  ')
    time.sleep(1)
    bersih()
    print ('\33[32;1m')
    os.system ('figlet GILANG SANJAYA XD.')
    print'\33[36;1m+\33[1;33m──────────────────────────────────────────────────\33[36;1m+'
    print'\33[36;1mAuthor    \33[31;1m: \33[1;33mGilang Sanjaya '
    print'\33[36;1mYoutube   \33[31;1m: \33[1;33mERROR SYSTEM 404 / MATI :v'
    print'\33[36;1mFacebook  \33[31;1m: \33[1;33mGilang Sanjaya XD.'
    print'\33[36;1mInstagram \33[31;1m: \33[1;33m@gilang_sanjayaaa'
    print'\33[36;1mGithub    \33[31;1m: \33[1;33mhttps://github.com/Gilang-sanjaya '
    print'\33[36;1m+\33[1;33m──────────────────────────────────────────────────\33[36;1m+'
    ...
    if gans in ['2']:
        ...
        os.system('git clone https://github.com/dz-id/smbf')
        bersih()
	time.sleep(2)
        print'\33[1;33mBERHASIL DIISNSTALL.......'
	bersih()
        os.system('cd smbf;python mbf.py')
	sys.exit
    if gans in ['3']:
        time.sleep(1)
        os.system('pkg update && pkg upgrade')
        ...
        os.system('git clone https://github.com/vrhasya/UNIS3X')
        bersih()
	time.sleep(2)
        print'\33[1;33mBERHASIL DIISNSTALL......'
	bersih()
        os.system('cd UNIS3X;python2 UNIS3X.py')
	sys.exit
    if gans in ['4']:
        time.sleep(1)
        os.system('pkg update && pkg upgrade')
        ...
        os.system('pip install module colorama futures')
        os.system('git clone https://github.com/kinarworo/mbf')
	bersih()
	time.sleep(2)
        print'\33[1;33mBERHASIL DIISNSTALL......'
	bersih()
	os.system('cd mbf;python mbf.py')
	sys.exit
    if gans in ['5']:
        time.sleep(1)
        ...
        os.system('git clone https://github.com/Tech-abm/Fb-Crack')
        os.system('pip2 install requests')
        os.system('pip2 install mechanize')
        bersih()
	time.sleep(3)
